...
client = MongoClient('mongodb+srv://anurag30:451442Aa@flask-chat-app.w6lv4md.mongodb.net/?retryWrites=true&w=majority')
...
def is_room_member(room_id, username):
    return room_members_collection.count_documents(
        {'_id': {'room_id': ObjectId(room_id), 'username': username}})  # errormaycoour


def is_room_admin(room_id, username):
    return room_members_collection.count_documents(
        {'_id': {'room_id': ObjectId(room_id), 'username': username}, 'is_room_admin': True})  # errormaycoour
